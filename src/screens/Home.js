...
class Home extends Component {
    ...
    constructor() {
        ...
        this.animatedRoundHeight = new Animated.Value(0)
    ...
    componentDidUpdate(prevProps, prevState) {
        this.state.roundClicked ? Animated.timing(this.animatedRoundHeight, {
            toValue: 120, duration: 500
        }).start() : Animated.timing(this.animatedRoundHeight, {
        ...
        return (
            ...
            <View style={{ flex: 1 }}>
                ...
                <Animated.View style={{
                    ...
                    height: this.animatedRoundHeight,
