            ...
            <View style={styles.container, this.props.style}>
                ...
                <TouchableWithoutFeedback >
                    <Animated.View style={ personStyle} >
                        <Icon name={"ios-person"} size={22} color="red"  onPress={() => this.props.nav.navigate("Contact")} />
                    </Animated.View>
                </TouchableWithoutFeedback>

                <TouchableWithoutFeedback  onPress={console.log('clicked info')} >
                    <Animated.View style={ infoStyle}>
                        <Icon name={"ios-information-circle-outline"} size={22} color="red"  onPress={() => this.props.nav.navigate("About")}  />
                    </Animated.View>
                </TouchableWithoutFeedback>

                <TouchableWithoutFeedback  onPress={console.log('clicked map')} >
                    <Animated.View style={mapStyle}  onPress={() => this.props.nav.navigate("Map")} >
                        <Icon name={"ios-compass"} size={22} color="red" />
                    </Animated.View>
                </TouchableWithoutFeedback>
